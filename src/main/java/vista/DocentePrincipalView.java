 ...
 * @author Yonathan
 */
public class DocentePrincipalView extends javax.swing.JFrame {
    ...
    public DocentePrincipalView() {
        ...
        modelo = new DefaultTableModel(
            new Object[]{"ID", "DUI", "Nombre", "Apellido", "Correo", "Teléfono", "Fecha Nac.", "Contrato", "Especialidad", "Grado Académico"},
            0
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DocentePrincipalView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
